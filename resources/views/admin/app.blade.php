...
<div class="wrapper">
    ...
    <div class="leftside-menu">
        <a href="{{route('dashboard')}}" class="logo logo-light">
            <span class="logo-lg">
                <h4 class="mt-3 mb-0">YouTube → Google Sheets Comment Tracker</h4>
            </span>
            <span class="logo-sm">
                <h4 class="mt-3 mb-0">Y-G</h4>
            </span>
        </a>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 text-center">
                        <script>document.write(new Date().getFullYear())</script> © Comment Tracker</b>
                    </div>
                </div>
            </div>
        </footer>
